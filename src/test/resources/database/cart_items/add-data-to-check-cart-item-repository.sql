...
insert into users (id, email, password, first_name, last_name, shipping_address) values (2, 'Jon1.doe@example.com', 'password1', 'firstName1', 'lastName1', 'shippingAddress1');
